...
function _preferencesPayloadFromUi(){
  ...
  const hideEmptyPanelCb=$('settingsHideEmptyPanel');
  if(hideEmptyPanelCb) payload.hide_empty_state_panel=hideEmptyPanelCb.checked;
...
async function loadSettingsPanel(){
  try{
    ...
    const hideEmptyPanelCb=$('settingsHideEmptyPanel');
    if(hideEmptyPanelCb){
      hideEmptyPanelCb.checked=settings.hide_empty_state_panel===true;
      window._hideEmptyStatePanel=hideEmptyPanelCb.checked;
      if(typeof applyEmptyStatePanelPref==='function') applyEmptyStatePanelPref();
      hideEmptyPanelCb.addEventListener('change',()=>{
        window._hideEmptyStatePanel=hideEmptyPanelCb.checked;
        if(typeof applyEmptyStatePanelPref==='function') applyEmptyStatePanelPref();
        _schedulePreferencesAutosave();
      },{once:false});
